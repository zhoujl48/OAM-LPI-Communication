...
if __name__ == '__main__':
    ...
    model_dir = 'model/cnn/noise_{:04d}_bias_{:03d}'.format(int(1000 * noise), bias)
    ...
    with open('evaluation/cnn/noise_{:04d}_bias_{:03d}.json'.format(int(1000 * noise), bias), 'w') as f:
